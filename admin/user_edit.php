<?php   
    ...
    if($_POST) {
        if(empty($_POST['name']) || empty($_POST['email']) ||  empty($_POST['address']) || empty($_POST['phone'])) {
            ...
            if($user) {
                echo "<script>alert('Yor email is already exists!')</script>";
            } else {
                if($password != null) {
                ...
                $result = $stmt->execute();
                if($result) {
                    echo "<script>alert('User is Updated successfully!');window.location.href='user_list.php';</script>";
                }
            }
        } 
    }
            ...
            <div class="card">
              ...
              <form action="user_edit.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" class="form-control" id="" cols="30" rows="10"><?php echo escape($result[0]['address']) ?></textarea>
                    </div>
